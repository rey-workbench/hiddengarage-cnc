...
export function generateGCodeFromImage(
  ...
  lines.push('; Tool: Ø' + config.toolDiameter + 'mm');
  lines.push('');
  ...
  // Generate toolpaths based on strategy
...
/**
 * Generate 2D Contour toolpath (cutting along edges)
 */
function generateContourToolpath(
  ...
  for (let pass = 1; pass <= numPasses; pass++) {
    ...
    contours.forEach((contour, idx) => {
      ...
      // Rapid to start point above work
...
/**
 * Generate 2D Pocket toolpath (filling enclosed areas)
 */
...
/**
 * Generate Engrave toolpath (tracing all lines)
 */
